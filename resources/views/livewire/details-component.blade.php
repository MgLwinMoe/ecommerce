                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                            ...
                            <del><div class="wrap-price"><span class="product-price regprice">${{$product->regular_price}}</span></div></del>
                        @else
                        ...
                        <div class="quantity">
                            ...
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-reduce" href="#" wire:click.prevent="decreamentQty"></a>
                                <a class="btn btn-increase" href="#" wire:click.prevent="increamentQty"></a>
                            </div>
                        </div>
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    ...
                                    <div class="wrap-btn">
                                        <a href="{{route('product.details', ['slug' => $r_product->slug] )}}" title="{{$r_product->name}}" class="function-link">quick view</a>
                                    </div>
                                </div>
                                <div class="product-info">
