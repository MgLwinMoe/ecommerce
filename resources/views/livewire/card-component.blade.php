        ...
        <div class=" main-content-area">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-increase" wire:click.preventDefault="increament('{{$item->rowId}}')"></a>
                                <a class="btn btn-reduce" wire:click.preventDefault="decreament('{{$item->rowId}}')"></a>
                            </div>
                        </div>
            ...
            <div class="summary">
                ...
                <div class="update-clear">
                    <a class="btn btn-clear" wire:click.prevent="removeAll()" href="#">Clear Shopping Cart</a>
